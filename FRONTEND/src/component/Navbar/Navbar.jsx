...
function Navbar() {
    ...
    const { failHints, isError, isLoading } = useSelector(
      (state) => state.user
    );
  ...
  console.log(isError, isLoading, failHints);
  if (failHints) {
    return (
      <div
        className="spinner-border  text-info lodNav"
            ...
            <li><a className="dropdown-item" href="/sell">SELL</a></li>
              ...
              >
                {userData ? (
                  ...
                  <>
                    {" "}
                    <button className="btn border border-success-subtle">
                      <Link
                        to="/login"
                        style={{
                          textDecoration: "none",
